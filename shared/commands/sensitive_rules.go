...
var SensitiveDirNamesToSkip = []string{
	"$RECYCLE.BIN", "Windows", "winnt", "System32", "SysWOW64",
	"System Volume Information", "ProgramData", "Program Files",
	"Program Files (x86)", "AppData", "MSOCache", "Config.Msi",
	"proc", "sys", "bin", "boot", "dev", "media", "mnt", "run", "lib", "lib64", "usr", "etc",
	"Fuzzing-Dicts", "obs-studio", "AppScan Standard",
